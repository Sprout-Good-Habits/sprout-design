# reasoning-transcript - Sprout Design Component Bundle

## Quick start

```html
<link rel="stylesheet" href="reasoning-transcript.bundle.css">
```

## What's included

**CSS bundle** (`reasoning-transcript.bundle.css`):
- Design tokens (CSS custom properties)
- reasoning-transcript.css
