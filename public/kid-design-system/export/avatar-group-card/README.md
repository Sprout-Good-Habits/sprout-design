# avatar-group-card - Sprout Design Component Bundle

## Quick start

```html
<link rel="stylesheet" href="avatar-group-card.bundle.css">
```

## What's included

**CSS bundle** (`avatar-group-card.bundle.css`):
- Design tokens (CSS custom properties)
- avatar.css
- avatar-group.css
- avatar-group-card.css
