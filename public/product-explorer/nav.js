...
window.DS_NAV = [
  {
    label: 'Kid Experience',
    icon: 'phone',
    href: '/product-explorer/kid/',
    collapsible: true,
    defaultOpen: true,
    children: [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Chat', icon: 'message-chat', badge: 'Ready', badgeColor: 'green', href: '/product-explorer/parent-chat-now.html' },
      { separator: true },
