...
window.DS_NAV = [
  {
    ...
    children: [
      ...
      { label: 'Microphone', icon: 'message-chat', surface: 'kid', href: '/product-explorer/task/microphone.html' },
      { label: 'Microphone Video', icon: 'video-recorder', surface: 'kid', href: '/product-explorer/task/microphone-video.html' },
